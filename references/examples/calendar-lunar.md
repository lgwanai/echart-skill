...
**Category:** `calendar`
**Official:** https://echarts.apache.org/examples/zh/editor.html?c=calendar-lunar
**Template:** examples/calendar-lunar.html
...
## Usage
- Build: `scripts/build_template.py examples/calendar-lunar.html -d data.json`
