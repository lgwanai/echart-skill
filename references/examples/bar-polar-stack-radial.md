# 极坐标系下的堆叠柱状图 / Stacked Bar Chart on Polar(Radial)

**Category:** `bar`
**Example dir:** `bar-polar-stack-radial`
**Difficulty:** 7
...
## Key Points
- This is an official ECharts example from `bar-polar-stack-radial/main.js`
