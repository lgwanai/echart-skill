...
- **Location**: `data: ['Profit', 'Expenses', 'Income']`
...
### data[2]: `series[0]`
- **Format**: `[n1,n2,...] — flat value array`
- **Location**: `data: [200, 170, 240, 244, 200, 220, 210]`
- **Replace with**: real data from DuckDB in the same format

### data[3]: `series`
- **Format**: `[n1,n2,...] — flat value array`
- **Location**: `data: [320, 302, 341, 374, 390, 450, 420]`
- **Replace with**: real data from DuckDB in the same format

### data[4]: `series`
- **Format**: `[n1,n2,...] — flat value array`
- **Location**: `data: [-120, -132, -101, -134, -190, -230, -210]`
- **Replace with**: real data from DuckDB in the same format
