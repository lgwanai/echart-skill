# 单轴散点图 / Scatter on Single Axis

**Category:** `scatter`
**Example dir:** `scatter-single-axis`
**Difficulty:** 3
...
data.forEach(function (dataItem) {
  series[dataItem[0]].data.push([dataItem
```
...
## Key Points
- This is an official ECharts example from `scatter-single-axis/main.js`
