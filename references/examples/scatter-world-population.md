...
**Category:** `scatter`
**Official:** https://echarts.apache.org/examples/zh/editor.html?c=scatter-world-population
**Template:** examples/scatter-world-population.html
...
## Usage
- Build: `scripts/build_template.py examples/scatter-world-population.html -d data.json`
