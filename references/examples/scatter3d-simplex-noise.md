# ä¸ç»´æ£ç¹å¾ - åçº¯å½¢åªå£° / Scatter3D - Simplex Noise

**Category:** `scatter3D`
**Example dir:** `scatter3d-simplex-noise`
**Difficulty:** 
...
## Key Points
- This is an official ECharts example from `scatter3d-simplex-noise/main.js`
