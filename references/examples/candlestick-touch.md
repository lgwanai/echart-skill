...
**Official:** https://echarts.apache.org/examples/zh/editor.html?c=candlestick-touch
**Template:** examples/candlestick-touch.html
...
## Usage
- Build: `scripts/build_template.py examples/candlestick-touch.html -d data.json`
