# 指数回归（使用统计插件） / Exponential Regression

**Category:** `scatter`
**Example dir:** `scatter-exponential-regression`
**Difficulty:** 1
...
## Key Points
- This is an official ECharts example from `scatter-exponential-regression/main.js`
