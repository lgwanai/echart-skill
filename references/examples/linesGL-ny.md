# LinesGL - å®æ¶äº¤äºççº½çº¦è¡éå¯è§å

**Category:** `linesGL`
**Official:** https://echarts.apache.org/examples/zh/editor.html?c=linesGL-ny
**Template:** examples/linesGL-ny.html
**Data Format:** `N/A`
...
titleCN: LinesGL - å®æ¶äº¤äºççº½çº¦è¡éå¯è§å
category: linesGL
*/
var CHUNK_COUNT = 32;
var dataCount = 0;
