# LinesGL - å®æ¶äº¤äºççº½çº¦è¡éå¯è§å / Use linesGL to draw 1 million New York streets

**Category:** `linesGL`
**Example dir:** `linesGL-ny`
**Difficulty:** 
...
## Key Points
- This is an official ECharts example from `linesGL-ny/main.js`
