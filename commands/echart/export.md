---
description: "导出查询或表到 CSV/Excel"
argument-hint: "<output> [--table <name>|--query <SQL>]"
---

# /echart-export

映射到 echart-skill 原始指令 `/export`。

## 任务

从 DuckDB 导出本地文件，保留数据本地化与审计链路。
...
- `/echart-export result.csv --table sales`
