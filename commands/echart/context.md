---
description: "会话管理和追问解析"
argument-hint: "start|resolve|history|context|list ..."
---

# /echart-context

映射到 echart-skill 原始指令 `/context`。

## 任务

维护当前分析表、指标、维度、时间范围和追问链。
...
- `/echart-context start sales`
- `/echart-context resolve "上个月呢？"`
