---
description: "设置全局/项目级统计口径"
argument-hint: "set|list|show|effective ..."
---

# /echart-scope

映射到 echart-skill 原始指令 `/scope`。

## 任务

设置企业指标口径。项目级口径记录项目目录，只在该目录及子目录下生效。
...
- `/echart-scope set --level project --name GMV --desc "SUM(pay_amount)"`
- `/echart-scope show`
