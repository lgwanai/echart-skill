...
argument-hint: "<table> <date_column> <metric> [--periods <n>]"
---

# /echart-forecast

映射到 echart-skill 原始指令 `/forecast`。

## 任务

使用本地预测方法输出趋势预测和置信说明，零外部依赖。
...
- `/echart-forecast orders order_date amount --periods 6`
