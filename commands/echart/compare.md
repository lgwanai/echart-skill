---
description: "执行指标对比分析"
argument-hint: "<table> <metric> <group_column> <baseline> <current>"
---

# /echart-compare

映射到 echart-skill 原始指令 `/compare`。

## 任务

对指定基准组和对比组进行本地 SUM/AVG/COUNT 指标变化分析，输出变化量和变化率。
...
- `/echart-compare sales amount month 2024-01 2024-02`
