---
description: "配置隐私脱敏开关"
argument-hint: "mask on|off"
---

# /echart-privacy

映射到 echart-skill 原始指令 `/privacy`。

## 任务

PII 脱敏默认关闭；开启后对手机号、邮箱、身份证、银行卡、薪资、地址等字段脱敏。
...
- `/echart-privacy mask on`
- `/echart-privacy mask off`
