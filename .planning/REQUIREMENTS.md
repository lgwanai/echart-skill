...
### Import Metadata & History

- [x] **META-01**: Every import records complete metadata (file path, table name, import time, row count, file location)
- [x] **META-02**: Table relationships tracked when merge/statistics operations create new tables
- [ ] **META-03**: Users can query and view import history in markdown table format
- [ ] **META-04**: Users can view table structures (columns, types, row counts) in markdown table format
